...
const bgDefault = chalk.bgRgb(255,255,255); 

const log = (message, messageType = MESSAGE_TYPES.INFO) => {
	switch(messageType) {
		case MESSAGE_TYPES.ERROR:
			console.error(bgDefault.bold.red(message));
			break;
		case MESSAGE_TYPES.WARN:
			console.warn(bgDefault.orange(message));
			break;
		case MESSAGE_TYPES.SUCCESS:
			console.log(bgDefault.green(message));
			break;
		default:
			console.log(message);
	}
